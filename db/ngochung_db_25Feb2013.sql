...
--
-- Host: localhost:3306
-- Generation Time: Feb 25, 2013 at 12:21 PM
...
(1, '001PT', 'thu', '2012-04-30 15:09:11', 'thutamungbienlai', '2012041', '2', 'Lư Thiết Hồ', '', '193 Tuy Lý Vương P12 Q8 Tp.HCM', '', 'thietho1982@yahoo.com', '0908696993', '', '', '', '', '', 500000, 'VND', 0, 500000, '', 'Thu tiền tạm ứng', '1'),
(2, '001PC', 'chi', '2012-05-14 15:22:50', 'tiendien', '4545', '', 'Cti', '', '', '', '', '5645', '', '', '', '', '', 2000000, 'VND', 0, 2000000, 'cash', 'Tra tien dien', ''),
(3, '002PT', 'thu', '2012-05-14 15:31:26', 'thutienkhachhang', '45546', '2', 'Lư Thiết Hồ', '', '193 Tuy Lý Vương P12 Q8 Tp.HCM', '', 'thietho1982@yahoo.com', '0908696993', '', '', '', '', '', 300000, 'VND', 0, 300000, 'cash', 'Tra bot', ''),
(4, '003PT', 'thu', '2012-05-14 15:34:24', 'thutamungbienlai', '2012051', '2', 'Lư Thiết Hồ', '', '193 Tuy Lý Vương P12 Q8 Tp.HCM', '', 'thietho1982@yahoo.com', '0908696993', '', '', '', '', '', 200000, 'VND', 0, 200000, '', 'Thu tiền tạm ứng', '2');
...
(1, '2012041', '2012-04-30', '2012-05-04', '2012-04-30 14:57:46', 'admin', '2', 'Lư Thiết Hồ', '0908696993', 'thietho1982@yahoo.com', '193 Tuy Lý Vương P12 Q8 Tp.HCM', 1200000, 1070000, 130000, 10, 500000, 'Làm gấp gấp', 'completed', 'active', '1'),
(2, '2012051', '2012-05-14', '2012-05-23', '2012-05-14 15:34:24', 'admin', '2', 'Lư Thiết Hồ', '0908696993', 'thietho1982@yahoo.com', '193 Tuy Lý Vương P12 Q8 Tp.HCM', 700000, 700000, 0, 0, 200000, 'frdg dfd', 'completed', 'active', '4');
...
CREATE TABLE `qlb_biennhanchitiet` (
  `id` bigint(20) NOT NULL auto_increment,
...
INSERT INTO `qlb_biennhanchitiet` (`id`, `biennhanid`, `dichvuid`, `tendichvu`, `sotien`, `ghichu`, `ngaylap`) VALUES
(1, 1, 6, 'Chụp hình cưới', 1000000, 'sdvfswed', '2012-04-30'),
(2, 1, 4, 'Ép lamina', 200000, 'wef ewd', '2012-04-30'),
(3, 2, 4, 'Ép lamina', 200000, NULL, '2012-05-14'),
(4, 2, 5, 'Chụp hình chân dung', 500000, NULL, '2012-05-14');
...
(2, 'Rửa hình', 30000, 'active'),
(3, 'Phuc hồi ảnh', 50000, 'active'),
(4, 'Ép lamina', 200000, 'active'),
(5, 'Chụp hình chân dung', 20000, 'active'),
(6, 'Chụp hình cưới', 1000000, 'active');
...
CREATE TABLE `user_stats` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 AUTO_INCREMENT=12902 ;
...
(12901, '2013-02-25 08:15:38', 'b4bf66fbaa8dc0e467f98d67e1de53a3', '', '58.186.225.77'),
(12900, '2013-02-25 08:06:15', '5a0205e90f2bcf53a6accaf13027456c', '', '115.78.131.180');
