...
<p>
	<label>Số tiền:</label> <?php echo $this->string->numberFormate($item['sotien'])?> <?php echo $this->document->tiente[$item['donvi']]?>
</p>
<p>
	<label>Số tiền viết bằng chử:</label> <?php echo $this->string->doc_so($item['sotien'])?> đồng
</p>
